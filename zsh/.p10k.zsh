# Generated by Powerlevel10k configuration wizard on 2026-09-21 at 14:08 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    status                  # exit code del ultimo comando
    command_execution_time  # duracion del comando
    background_jobs         # jobs en background
    nvm                     # version de node
    aws                     # perfil AWS — siempre visible para multi-cuenta
    time                    # hora actual
  )
